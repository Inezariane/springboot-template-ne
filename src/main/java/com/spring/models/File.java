...
import com.spring.audits.InitiatorAudit;
import com.spring.enums.EFileSizeType;
import com.spring.enums.EFileStatus;
...
public class File extends InitiatorAudit {
    ...
    public String getUrl() {
        return "http://localhost:8087/api/files/load-file" + "/" + this.getName();
    }
}
